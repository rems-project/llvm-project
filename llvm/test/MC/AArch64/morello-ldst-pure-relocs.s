...
// ASM-NEXT:   fixup A - offset: 0, value: anywhere, kind: fixup_aarch64_ldr_pcrel_imm17_scale16
  ...
  ldr c0, [c1, :lo12:sym]
  str c1, [c2, :lo12:sym]
  ldr c0, [c1, :lo12:sym+1]
  str c1, [c2, :lo12:sym+1]
...
// ASM:  ldr c0, [c1, :lo12:sym]                // encoding: [0x20,0bAAAAAA00,0b01AAAAAA,0xc2]
// ASM-NEXT:                                    //   fixup A - offset: 0, value: :lo12:sym, kind: fixup_aarch64_ldst_imm12_scale16
// ASM:  str c1, [c2, :lo12:sym]                // encoding: [0x41,0bAAAAAA00,0b00AAAAAA,0xc2]
// ASM-NEXT:                                    //   fixup A - offset: 0, value: :lo12:sym, kind: fixup_aarch64_ldst_imm12_scale16
// ASM:  ldr c0, [c1, :lo12:sym+1]              // encoding: [0x20,0bAAAAAA00,0b01AAAAAA,0xc2]
// ASM-NEXT:                                    //   fixup A - offset: 0, value: :lo12:sym+1, kind: fixup_aarch64_ldst_imm12_scale16
// ASM:  str c1, [c2, :lo12:sym+1]              // encoding: [0x41,0bAAAAAA00,0b00AAAAAA,0xc2]
// ASM-NEXT:                                    //   fixup A - offset: 0, value: :lo12:sym+1, kind: fixup_aarch64_ldst_imm12_scale16

  ldr c0, [c1, :got_lo12:sym]
  str c1, [c2, :got_lo12:sym]
  ldr c0, [c1, :got_lo12:sym+1]
  str c1, [c2, :got_lo12:sym+1]
...
// ASM:  ldr c0, [c1, :got_lo12:sym]            // encoding: [0x20,0bAAAAAA00,0b01AAAAAA,0xc2]
// ASM-NEXT:                                    //   fixup A - offset: 0, value: :got_lo12:sym, kind: fixup_aarch64_ldst_imm12_scale16
// ASM:  str c1, [c2, :got_lo12:sym]            // encoding: [0x41,0bAAAAAA00,0b00AAAAAA,0xc2]
// ASM-NEXT:                                    //   fixup A - offset: 0, value: :got_lo12:sym, kind: fixup_aarch64_ldst_imm12_scale16
// ASM:  ldr c0, [c1, :got_lo12:sym+1]          // encoding: [0x20,0bAAAAAA00,0b01AAAAAA,0xc2]
// ASM-NEXT:                                    //   fixup A - offset: 0, value: :got_lo12:sym+1, kind: fixup_aarch64_ldst_imm12_scale16
// ASM:  str c1, [c2, :got_lo12:sym+1]          // encoding: [0x41,0bAAAAAA00,0b00AAAAAA,0xc2]
// ASM-NEXT:                                    //   fixup A - offset: 0, value: :got_lo12:sym+1, kind: fixup_aarch64_ldst_imm12_scale16
