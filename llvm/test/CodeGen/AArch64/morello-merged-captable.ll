...
; CHECK-NEXT: .chericap x3
; CHECK-NEXT: .chericap x4
; CHECK-NEXT: .chericap x5
; CHECK-NEXT: .chericap x6
; CHECK-NEXT: .chericap x7
; CHECK-NEXT: .chericap x8
; CHECK-NEXT: .chericap x9
; CHECK-NEXT: .chericap x10
; CHECK-NEXT: .chericap x11
; CHECK-NEXT: .chericap x12
; CHECK-NEXT: .chericap x13
; CHECK-NEXT: .chericap x14
; CHECK-NEXT: .chericap x15
; CHECK-NEXT: .chericap x16
; CHECK-NEXT: .chericap x17
; CHECK-NEXT: .chericap x18
; CHECK-NEXT: .chericap x19
