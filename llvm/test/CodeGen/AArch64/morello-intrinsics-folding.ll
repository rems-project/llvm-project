; RUN: opt -march=arm64 -mattr=+c64,+morello -target-abi purecap -S -cheri-fold-intrisics %s -o %t.ll
; RUN: FileCheck %s -input-file %t.ll
; Check that the dynamic GEP is folded properly
; RUN: llc -O2 %t.ll -o - -march=arm64 -mattr=+c64,+morello -target-abi purecap | FileCheck %s -check-prefix DYNAMIC-GEP-ASM

target datalayout = "e-m:e-pf200:128:128:128:64-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128-A200-P200-G200"
target triple = "aarch64-none-elf"

; This test was Adapted from cheri-intrinsics-folding.ll.
...
define i8 addrspace(200)* @fold_inc_gep_sequence_null() local_unnamed_addr #1 {
  ...
  ; CHECK: [[PTR1:%.+]] = getelementptr inbounds i8, i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 100), i64 -4
  ; CHECK-NEXT: [[PTR2:%.+]] = getelementptr inbounds i8, i8 addrspace(200)* [[PTR1]], i64 -4
  ; CHECK-NEXT: [[PTR3:%.+]] = getelementptr i8, i8 addrspace(200)* [[PTR2]], i64 -10
}
...
entry:
  ...
  ; CHECK: [[PTR1:%.+]] = getelementptr i8, i8 addrspace(200)* %arg, i64 100
  ; CHECK-NEXT: [[PTR2:%.+]] = getelementptr inbounds i8, i8 addrspace(200)* [[PTR1]], i64 -4
  ; CHECK-NEXT: [[PTR3:%.+]] = getelementptr inbounds i8, i8 addrspace(200)* [[PTR2]], i64 -4
  ; CHECK-NEXT: [[PTR4:%.+]] = getelementptr i8, i8 addrspace(200)* [[PTR3]], i64 -10
}
...
entry:
  ...
  ; CHECK: [[PTR1:%.+]] = getelementptr inbounds i8, i8 addrspace(200)* %arg, i64 -4
  ; CHECK-NEXT: [[PTR2:%.+]] = getelementptr i8, i8 addrspace(200)* [[PTR1]], i64 100
...
entry:
  ...
  ; DYNAMIC-GEP-ASM:       add	x8, x1, #90 
  ; DYNAMIC-GEP-ASM-NEXT:  scoff c0, c0, x8
}
