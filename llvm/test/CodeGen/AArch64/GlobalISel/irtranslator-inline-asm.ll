...
define i64 @asm_register_early_clobber() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"mov $0, 7; mov $1, 7", 1 /* sideeffect attdialect */, 2228235 /* regdef-ec:GPR64common */, def early-clobber %0, 2228235 /* regdef-ec:GPR64common */, def early-clobber %1, !0
...
define i32 @test_single_register_output() nounwind ssp {
  ...
  ; CHECK: bb.1.entry:
  ; CHECK-NEXT:   INLINEASM &"mov ${0:w}, 7", 0 /* attdialect */, 655370 /* regdef:GPR32common */, def %0
...
define i64 @test_single_register_output_s64() nounwind ssp {
  ...
  ; CHECK: bb.1.entry:
  ; CHECK-NEXT:   INLINEASM &"mov $0, 7", 0 /* attdialect */, 2228234 /* regdef:GPR64common */, def %0
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s64) = COPY %0
...
define float @test_multiple_register_outputs_same() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"mov $0, #0; mov $1, #0", 0 /* attdialect */, 655370 /* regdef:GPR32common */, def %0, 655370 /* regdef:GPR32common */, def %1
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %0
...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"mov $0, #0; mov $1, #0", 0 /* attdialect */, 655370 /* regdef:GPR32common */, def %0, 2031626 /* regdef:FPR64 */, def %1
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s64) = COPY %1
...
define zeroext i8 @test_register_output_trunc(i8* %src) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"mov ${0:w}, 32", 0 /* attdialect */, 655370 /* regdef:GPR32common */, def %1
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s32) = COPY %1
...
define void @test_input_register_imm() {
  ...
  ; CHECK-NEXT:   INLINEASM &"mov x0, $0", 1 /* sideeffect attdialect */, 2228233 /* reguse:GPR64common */, [[COPY]]
  ; CHECK-NEXT:   RET_ReallyLR
...
define zeroext i8 @test_input_register(i8* %src) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"ldtrb ${0:w}, [$1]", 0 /* attdialect */, 655370 /* regdef:GPR32common */, def %1, 2228233 /* reguse:GPR64common */, [[COPY1]]
...
define i16 @test_anyext_input() {
  ...
  ; CHECK-NEXT:   INLINEASM &"", 1 /* sideeffect attdialect */, 655370 /* regdef:GPR32common */, def %0, 655369 /* reguse:GPR32common */, [[COPY]]
...
define i16 @test_anyext_input_with_matching_constraint() {
  ...
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(s32) = G_ANYEXT [[C]](s16)
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:gpr32common = COPY [[ANYEXT]](s32)
  ; CHECK-NEXT:   INLINEASM &"", 1 /* sideeffect attdialect */, 655370 /* regdef:GPR32common */, def %0, 2147483657 /* reguse tiedto:$0 */, [[COPY]](tied-def 3)
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s32) = COPY %0
  ; CHECK-NEXT:   [[TRUNC:%[0-9]+]]:_(s16) = G_TRUNC [[COPY1]](s32)
  ; CHECK-NEXT:   [[ANYEXT1:%[0-9]+]]:_(s32) = G_ANYEXT [[TRUNC]](s16)
  ; CHECK-NEXT:   $w0 = COPY [[ANYEXT1]](s32)
