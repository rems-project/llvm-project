...
; CHECK-NEXT:    [[TMP4:%.*]] = add nuw i64 [[LSR_IV_NEXT2]], [[TMP3]]
; CHECK-NEXT:    [[SCEVGEP:%.*]] = getelementptr i8, i8 addrspace(200)* undef, i64 [[TMP4]]
; CHECK-NEXT:    [[TMP5:%.*]] = tail call i64 @llvm.cheri.cap.diff.i64(i8 addrspace(200)* nonnull [[SCEVGEP]], i8 addrspace(200)* nonnull [[ADD_PTR4_I1244_I]])
