...
; RUN: llc -march=aarch64 -mattr=+morello,+new-morello-vararg -o - %s | FileCheck %s
...
define dso_local void @test_varargs(%struct.__va_list* noalias sret align 8 %agg.result, i32 %count, ...) local_unnamed_addr #0 {
