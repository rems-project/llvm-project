...
entry:
  ...
  ; CHECK: call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(6) bitcast (%struct.anon* @g to i8*), i8* noundef nonnull align 4 dereferenceable(6) bitcast (void ()* @h to i8*), i64 6, i1 false)
  ret void
}
