...
; CHECK-NEXT: !41 = !DILocalVariable(name: "Name", arg: 1, scope: {{.*}}, file: {{.*}}, line: 13, type: {{.*}})
!43 = distinct !DISubprogram(name: "fn", scope: !12, file: !12, spFlags: 0)
!44 = !DILocalVariable(name: "Name", arg: 1, scope: !43, file: !12, line: 13, type: !7)

; CHECK: !42 = !DIBasicType(name: "__intcap_t", size: 128, encoding: DW_ATE_CHERI_signed_intcap)
; CHECK-NEXT: !43 = !DIBasicType(name: "__uintcap_t", size: 128, encoding: DW_ATE_CHERI_unsigned_intcap)
!45 = !DIBasicType(name: "__intcap_t", size: 128, encoding: DW_ATE_CHERI_signed_intcap)
!46 = !DIBasicType(name: "__uintcap_t", size: 128, encoding: DW_ATE_CHERI_unsigned_intcap)
