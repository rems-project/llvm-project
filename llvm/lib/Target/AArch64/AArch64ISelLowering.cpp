...
const char *AArch64TargetLowering::getTargetNodeName(unsigned Opcode) const {
  ...
  case AArch64ISD::CCALL:             return "AArch64ISD::CCALL";
  case AArch64ISD::ClearCALL:         return "AArch64ISD::ClearCALL";
  case AArch64ISD::ClearCCALL:        return "AArch64ISD::ClearCCALL";
  case AArch64ISD::ADRP:              return "AArch64ISD::ADRP";
  case AArch64ISD::ADRPC:             return "AArch64ISD::ADRPC";
  case AArch64ISD::ADR:               return "AArch64ISD::ADR";
  case AArch64ISD::ADDlow:            return "AArch64ISD::ADDlow";
  case AArch64ISD::ADDClow:           return "AArch64ISD::ADDClow";
  case AArch64ISD::LOADgot:           return "AArch64ISD::LOADgot";
  case AArch64ISD::LOADCgot:          return "AArch64ISD::LOADCgot";
  case AArch64ISD::RET_FLAG:          return "AArch64ISD::RET_FLAG";
  case AArch64ISD::CRET_FLAG:         return "AArch64ISD::CRET_FLAG";
  ...
  case AArch64ISD::CTC_RETURN:        return "AArch64ISD::CTC_RETURN";
  case AArch64ISD::ClearTC_RETURN:    return "AArch64ISD::ClearTC_RETURN";
  case AArch64ISD::ClearCTC_RETURN:   return "AArch64ISD::ClearCTC_RETURN";
  ...
  case AArch64ISD::CapAlignDown:      return "AArch64ISD::CapAlignDown";
  case AArch64ISD::CapAlignUp:        return "AArch64ISD::CapAlignUp";
  case AArch64ISD::CCheckPermS:       return "AArch64ISD::CCheckPermS";
  case AArch64ISD::CCheckTypeS:       return "AArch64ISD::CCheckTypeS";
  case AArch64ISD::CapCheckEquals:    return "AArch64ISD::CapCheckEquals";
  case AArch64ISD::CapCheckSubset:    return "AArch64ISD::CapCheckSubset";
  case AArch64ISD::CapCheckSubsetUnseal:
                                      return "AArch64ISD::CapCheckSubsetUnseal";
  case AArch64ISD::CapSealImm:        return "AArch64ISD::CapSealImm";
  case AArch64ISD::CapTagGet:         return "AArch64ISD::CapTagGet";
  case AArch64ISD::ClearPerms:        return "AArch64ISD::ClearPerms";
  case AArch64ISD::CapSealedGet:      return "AArch64ISD::CapSealedGet";
...
SDValue AArch64TargetLowering::LowerINTRINSIC_WO_CHAIN(SDValue Op,
  ...
  case Intrinsic::cheri_cap_bit_equals:
  case Intrinsic::cheri_cap_subset_test: {
    if (Subtarget->hasMorello()) {
      unsigned opcode, cond;
      if (IntNo == Intrinsic::cheri_cap_bit_equals) {
...
void AArch64TargetLowering::saveVarArgRegisters(CCState &CCInfo,
  ...
  if (GPRSaveSize != 0) {
    if (IsWin64) {
      ...
      GPRIdx = MFI.CreateStackObject(GPRSaveSize, HasCap ? 16 : 8, false);
...
SDValue AArch64TargetLowering::LowerCallResult(
  ...
  CCAssignFn *RetCC = HasPureCap ? (Use32CapRegs ? RetCC_AArch64_AAPCS_Pure_32Cap_Regs
                                                 : RetCC_AArch64_AAPCS_Pure_16Cap_Regs)
                                 : (CallConv == CallingConv::WebKit_JS
...
AArch64TargetLowering::LowerCall(CallLoweringInfo &CLI,
  ...
  unsigned Opcode;
  if (IsCapabilityCall)
    Opcode = ClearRegs ? AArch64ISD::ClearCCALL : AArch64ISD::CCALL;
  else
    Opcode = ClearRegs ? AArch64ISD::ClearCALL : AArch64ISD::CALL;
...
SDValue AArch64TargetLowering::LowerGlobalAddress(SDValue Op,
  ...
  if (!IsLargeCM && Op.getSimpleValueType() == MVT::iFATPTR128) {
    ...
    if (SG) {
      ...
      SDValue Addr =
          DAG.getGlobalAddress(AddrGV, DL, Subtarget->hasC64() ? MVT::iFATPTR128
                                                               : MVT::i64);
      ...
      SDValue GlobalAddr = DAG.getLoad(
          ...
          MachinePointerInfo(AddrGV, 0), 16,
          MachineMemOperand::MONonTemporal | MachineMemOperand::MOInvariant |
          MachineMemOperand::MODereferenceable);
...
AArch64TargetLowering::LowerELFGlobalTLSAddress(SDValue Op,
  ...
  if (Model == TLSModel::LocalExec) {
    SDValue TPWithOff = LowerELFTLSLocalExec(GV, ThreadBase, DL, DAG);
    if (GV->getType()->getAddressSpace() == 200) {
      TPWithOff = getAddrFromDDC(TPWithOff, DAG);
    }
    return TPWithOff;
  } else if (Model == TLSModel::InitialExec) {
    if (Subtarget->hasCapGOT())
...
Value *AArch64TargetLowering::emitLoadLinked(IRBuilder<> &Builder, Value *Addr,
  ...
  if (PointerType *PT = dyn_cast<PointerType>(BasePTy->getElementType())) {
    unsigned AS = PT->getAddressSpace();
    if (M->getDataLayout().isFatPointer(AS))
      IsFatPointer = true;
  }
