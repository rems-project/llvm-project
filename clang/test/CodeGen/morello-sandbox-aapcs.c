...
// CHECK: define void @fun6(%struct.ff4 addrspace(200)* noalias sret %{{.*}}, %struct.ff4 addrspace(200)* %{{.*}}, %struct.ff4 addrspace(200)* %{{.*}}, %struct.ff4 addrspace(200)* %{{.*}})
// CHECK: ret void
...
// CHECK: define void @fun8(%struct.ff6 addrspace(200)* noalias sret %{{.*}}, %struct.ff6 addrspace(200)* %{{.*}}, %struct.ff6 addrspace(200)* %{{.*}}, %struct.ff6 addrspace(200)* %{{.*}})
// CHECK: ret void
...
// CHECK: define void @fun11(%struct.ff9 addrspace(200)* noalias sret %{{.*}}, %struct.ff9 addrspace(200)* %{{.*}}, %struct.ff9 addrspace(200)* %{{.*}}, %struct.ff9 addrspace(200)* %{{.*}})
// CHECK: ret void
