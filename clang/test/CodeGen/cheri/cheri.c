...
// PTRS-AARCH64: define i64 @cheri_length_get(i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i64 -1
// PTRS-AARCH64: define i64 @cheri_base_get(i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i64 -1
// PTRS-AARCH64: define i64 @cheri_offset_get(i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i64 -1
// PTRS-AARCH64: define i8* @cheri_offset_set(i8* readnone returned %{{.*}}, i64  %{{.*}})
// PTRS-AARCH64: ret i8* %{{.*}}
// PTRS-AARCH64: define i32 @cheri_type_get(i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i32 0
// PTRS-AARCH64: define i32 @cheri_perms_get(i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i32 0
// PTRS-AARCH64: define i8* @cheri_perms_and(i8* readnone returned %{{.*}}, i32 %{{.*}})
// PTRS-AARCH64: ret i8* %{{.*}}
// PTRS-AARCH64: define i1 @cheri_tag_get(i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i1 false
// PTRS-AARCH64: define i1 @cheri_sealed_get(i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i1 false
// PTRS-AARCH64: define i8* @cheri_offset_increment(i8* readnone %{{.*}}, i64 %{{.*}})
// PTRS-AARCH64: %{{.*}} = getelementptr inbounds i8, i8* %{{.*}}, i64 %{{.*}}
// PTRS-AARCH64: ret i8* %{{.*}}
// PTRS-AARCH64: define i8* @cheri_tag_clear(i8* readnone returned %{{.*}})
// PTRS-AARCH64: ret i8* %{{.*}}
// PTRS-AARCH64: define i8* @cheri_seal(i8* readnone returned %{{.*}}, i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i8* %{{.*}}
// PTRS-AARCH64: define i8* @cheri_unseal(i8* readnone returned %{{.*}}, i8* nocapture readnone %{{.*}})
// PTRS-AARCH64: ret i8* %{{.*}}
// PTRS-AARCH64: define i8* @cheri_bounds_set(i8* readnone returned %{{.*}}, i64 %{{.*}})
// PTRS-AARCH64: ret i8* %{{.*}}
...
// CAPS: %__builtin_cheri_offset_increment = getelementptr i8, i8 addrspace(200)* %{{.*}}, i64 %{{.*}}
...
// CAPS-AARCH64: define i64 @cheri_length_get(i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i64 @llvm.cheri.cap.length.get.i64(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i64 @cheri_base_get(i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i64 @llvm.cheri.cap.base.get.i64(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i64 @cheri_offset_get(i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i64 @llvm.cheri.cap.offset.get.i64(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i8 addrspace(200)* @cheri_offset_set(i8 addrspace(200)* readnone %{{.*}}, i64 %{{.*}})
// CAPS-AARCH64: call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* %{{.*}}, i64 %{{.*}})
// CAPS-AARCH64: define i32 @cheri_type_get(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: call i64 @llvm.cheri.cap.type.get.i64(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i32 @cheri_perms_get(i8 addrspace(200)*  %{{.*}})
// CAPS-AARCH64: call i64 @llvm.cheri.cap.perms.get.i64(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i8 addrspace(200)* @cheri_perms_and(i8 addrspace(200)* readnone %{{.*}}, i32 %{{.*}})
// CAPS-AARCH64: call i8 addrspace(200)* @llvm.cheri.cap.perms.and.i64(i8 addrspace(200)* %{{.*}}, i64
// CAPS-AARCH64: define i1 @cheri_tag_get(i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i1 @llvm.cheri.cap.tag.get(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i1 @cheri_sealed_get(i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i1 @llvm.cheri.cap.sealed.get(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i8 addrspace(200)* @cheri_offset_increment(i8 addrspace(200)* readnone %{{.*}}, i64 %{{.*}})
// CAPS-AARCH64: getelementptr i8, i8 addrspace(200)* {{.*}}, i64
// CAPS-AARCH64: define i8 addrspace(200)* @cheri_tag_clear(i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i8 addrspace(200)* @llvm.cheri.cap.tag.clear(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i8 addrspace(200)* @cheri_seal(i8 addrspace(200)* readnone %{{.*}}, i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i8 addrspace(200)* @llvm.cheri.cap.seal(i8 addrspace(200)* %{{.*}}, i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i8 addrspace(200)* @cheri_unseal(i8 addrspace(200)* readnone %{{.*}}, i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i8 addrspace(200)* @llvm.cheri.cap.unseal(i8 addrspace(200)* %{{.*}}, i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i8 addrspace(200)* @cheri_bounds_set(i8 addrspace(200)* readnone %{{.*}}, i64 %{{.*}})
// CAPS-AARCH64: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.*}}, i64 %{{.*}})
// CAPS-AARCH64: define i64 @cheri_round_representable_length(i64 %{{.*}})
// CAPS-AARCH64: call i64 @llvm.cheri.round.representable.length.i64(i64 %{{.*}})
// CAPS-AARCH64: define i64 @cheri_round_representable_mask(i64 %{{.*}})
// CAPS-AARCH64: call i64 @llvm.cheri.representable.alignment.mask.i64(i64 %{{.*}})
// CAPS-AARCH64: define i64 @cheri_copy_from_high(i8 addrspace(200)* readnone %{{.*}})
// CAPS-AARCH64: call i64 @llvm.cheri.cap.copy.from.high.i64(i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i8 addrspace(200)* @cheri_copy_to_high(i8 addrspace(200)* readnone %{{.*}}, i64 %{{.*}})
// CAPS-AARCH64: call i8 addrspace(200)* @llvm.cheri.cap.copy.to.high.i64(i8 addrspace(200)* %{{.*}}, i64 %{{.*}})
// CAPS-AARCH64: define i64 @cheri_equal_exact(i8 addrspace(200)* %{{.*}}, i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: call i1 @llvm.cheri.cap.equal.exact(i8 addrspace(200)* %{{.*}}, i8 addrspace(200)* %{{.*}})
// CAPS-AARCH64: define i64 @cheri_subset_test(i8 addrspace(200)* %{{.*}}, i8 addrspace(200)* %{{.*}})
