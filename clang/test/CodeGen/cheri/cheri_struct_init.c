...
// RXUN: %cheri_purecap_cc1 -S -o - %s | FileCheck %s -check-prefix ASM
...
// CHECK-NEXT: @compr = addrspace(200) constant [1 x { [8 x i8], i64, [3 x i8 addrspace(200)*], i32 }] [{ [8 x i8], i64, [3 x i8 addrspace(200)*], i32 }
