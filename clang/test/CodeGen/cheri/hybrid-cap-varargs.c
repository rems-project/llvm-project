...
// MIPS-NEXT:    [[TMP0:%.*]] = call i8 addrspace(200)* @llvm.cheri.cap.address.set.i64(i8 addrspace(200)* null, i64 0)
// MIPS-NEXT:    store i8 addrspace(200)* [[TMP0]], i8 addrspace(200)** [[NULL_UINTCAP]], align 16
// MIPS-NEXT:    [[TMP1:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** [[NULL_CAP]], align 16
// MIPS-NEXT:    [[TMP2:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** [[NULL_UINTCAP]], align 16
// MIPS-NEXT:    [[TMP3:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** @cap, align 16
// MIPS-NEXT:    [[TMP4:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** @uintcap, align 16
// MIPS-NEXT:    call void (i64, ...) @callee(i64 signext 0, i8 addrspace(200)* [[TMP1]], i8 addrspace(200)* [[TMP2]], i8 addrspace(200)* [[TMP3]], i8 addrspace(200)* [[TMP4]])
// MIPS-NEXT:    [[TMP5:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds ({ i8 addrspace(200)* }, { i8 addrspace(200)* }* bitcast (%struct.single_cap* @single_cap to { i8 addrspace(200)* }*), i32 0, i32 0), align 16
// MIPS-NEXT:    call void (i64, ...) @callee(i64 signext 1, i64 undef, i8 addrspace(200)* inreg [[TMP5]])
// MIPS-NEXT:    [[TMP6:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds ({ i8 addrspace(200)*, i8 addrspace(200)* }, { i8 addrspace(200)*, i8 addrspace(200)* }* bitcast (%struct.double_cap* @double_cap to { i8 addrspace(200)*, i8 addrspace(200)* }*), i32 0, i32 0), align 16
// MIPS-NEXT:    [[TMP7:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds ({ i8 addrspace(200)*, i8 addrspace(200)* }, { i8 addrspace(200)*, i8 addrspace(200)* }* bitcast (%struct.double_cap* @double_cap to { i8 addrspace(200)*, i8 addrspace(200)* }*), i32 0, i32 1), align 16
// MIPS-NEXT:    call void (i64, ...) @callee(i64 signext 2, i64 undef, i8 addrspace(200)* inreg [[TMP6]], i8 addrspace(200)* inreg [[TMP7]])
// MIPS-NEXT:    [[TMP8:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds ({ i8 addrspace(200)* }, { i8 addrspace(200)* }* bitcast (%struct.single_cap_array* @single_cap_array to { i8 addrspace(200)* }*), i32 0, i32 0), align 16
// MIPS-NEXT:    call void (i64, ...) @callee(i64 signext 3, i64 undef, i8 addrspace(200)* inreg [[TMP8]])
// MIPS-NEXT:    [[TMP9:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds ({ i8 addrspace(200)*, i8 addrspace(200)* }, { i8 addrspace(200)*, i8 addrspace(200)* }* bitcast (%struct.double_cap_array* @double_cap_array to { i8 addrspace(200)*, i8 addrspace(200)* }*), i32 0, i32 0), align 16
// MIPS-NEXT:    [[TMP10:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds ({ i8 addrspace(200)*, i8 addrspace(200)* }, { i8 addrspace(200)*, i8 addrspace(200)* }* bitcast (%struct.double_cap_array* @double_cap_array to { i8 addrspace(200)*, i8 addrspace(200)* }*), i32 0, i32 1), align 16
// MIPS-NEXT:    call void (i64, ...) @callee(i64 signext 4, i64 undef, i8 addrspace(200)* inreg [[TMP9]], i8 addrspace(200)* inreg [[TMP10]])
// MIPS-NEXT:    [[TMP11:%.*]] = load i64, i64* getelementptr inbounds ({ i64, i64, i8 addrspace(200)* }, { i64, i64, i8 addrspace(200)* }* bitcast (%struct.mixed* @mixed to { i64, i64, i8 addrspace(200)* }*), i32 0, i32 0), align 16
// MIPS-NEXT:    [[TMP12:%.*]] = load i64, i64* getelementptr inbounds ({ i64, i64, i8 addrspace(200)* }, { i64, i64, i8 addrspace(200)* }* bitcast (%struct.mixed* @mixed to { i64, i64, i8 addrspace(200)* }*), i32 0, i32 1), align 8
// MIPS-NEXT:    [[TMP13:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds ({ i64, i64, i8 addrspace(200)* }, { i64, i64, i8 addrspace(200)* }* bitcast (%struct.mixed* @mixed to { i64, i64, i8 addrspace(200)* }*), i32 0, i32 2), align 16
// MIPS-NEXT:    call void (i64, ...) @callee(i64 signext 5, i64 undef, i64 inreg [[TMP11]], i64 inreg [[TMP12]], i8 addrspace(200)* inreg [[TMP13]])
// MIPS-NEXT:    [[TMP14:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds (%union.int_or_cap, %union.int_or_cap* @int_or_cap, i32 0, i32 0), align 16
// MIPS-NEXT:    call void (i64, ...) @callee(i64 signext 6, i64 undef, i8 addrspace(200)* inreg [[TMP14]])
// MIPS-NEXT:    ret void
//
...
// RV32IXCHERI-NEXT:    [[TMP0:%.*]] = call i8 addrspace(200)* @llvm.cheri.cap.address.set.i32(i8 addrspace(200)* null, i32 0)
// RV32IXCHERI-NEXT:    store i8 addrspace(200)* [[TMP0]], i8 addrspace(200)** [[NULL_UINTCAP]], align 8
// RV32IXCHERI-NEXT:    [[TMP1:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** [[NULL_CAP]], align 8
// RV32IXCHERI-NEXT:    [[TMP2:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** [[NULL_UINTCAP]], align 8
// RV32IXCHERI-NEXT:    [[TMP3:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** @cap, align 8
// RV32IXCHERI-NEXT:    [[TMP4:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** @uintcap, align 8
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 0, i8 addrspace(200)* [[TMP1]], i8 addrspace(200)* [[TMP2]], i8 addrspace(200)* [[TMP3]], i8 addrspace(200)* [[TMP4]])
// RV32IXCHERI-NEXT:    [[TMP5:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds (%struct.single_cap, %struct.single_cap* @single_cap, i32 0, i32 0), align 8
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 1, i8 addrspace(200)* [[TMP5]])
// RV32IXCHERI-NEXT:    [[TMP6:%.*]] = bitcast %struct.double_cap* [[BYVAL_TEMP]] to i8*
// RV32IXCHERI-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 [[TMP6]], i8* align 8 bitcast (%struct.double_cap* @double_cap to i8*), i32 16, i1 false)
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 2, %struct.double_cap* [[BYVAL_TEMP]])
// RV32IXCHERI-NEXT:    [[TMP7:%.*]] = load [1 x i8 addrspace(200)*], [1 x i8 addrspace(200)*]* getelementptr inbounds (%struct.single_cap_array, %struct.single_cap_array* @single_cap_array, i32 0, i32 0), align 8
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 3, [1 x i8 addrspace(200)*] [[TMP7]])
// RV32IXCHERI-NEXT:    [[TMP8:%.*]] = bitcast %struct.double_cap_array* [[BYVAL_TEMP1]] to i8*
// RV32IXCHERI-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 [[TMP8]], i8* align 8 bitcast (%struct.double_cap_array* @double_cap_array to i8*), i32 16, i1 false)
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 4, %struct.double_cap_array* [[BYVAL_TEMP1]])
// RV32IXCHERI-NEXT:    [[TMP9:%.*]] = bitcast %struct.mixed* [[BYVAL_TEMP2]] to i8*
// RV32IXCHERI-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 [[TMP9]], i8* align 8 bitcast (%struct.mixed* @mixed to i8*), i32 16, i1 false)
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 5, %struct.mixed* [[BYVAL_TEMP2]])
// RV32IXCHERI-NEXT:    [[TMP10:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds (%union.int_or_cap, %union.int_or_cap* @int_or_cap, i32 0, i32 0), align 8
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 6, i8 addrspace(200)* [[TMP10]])
...
// RV64IXCHERI-NEXT:    [[TMP0:%.*]] = call i8 addrspace(200)* @llvm.cheri.cap.address.set.i64(i8 addrspace(200)* null, i64 0)
// RV64IXCHERI-NEXT:    store i8 addrspace(200)* [[TMP0]], i8 addrspace(200)** [[NULL_UINTCAP]], align 16
// RV64IXCHERI-NEXT:    [[TMP1:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** [[NULL_CAP]], align 16
// RV64IXCHERI-NEXT:    [[TMP2:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** [[NULL_UINTCAP]], align 16
// RV64IXCHERI-NEXT:    [[TMP3:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** @cap, align 16
// RV64IXCHERI-NEXT:    [[TMP4:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** @uintcap, align 16
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 0, i8 addrspace(200)* [[TMP1]], i8 addrspace(200)* [[TMP2]], i8 addrspace(200)* [[TMP3]], i8 addrspace(200)* [[TMP4]])
// RV64IXCHERI-NEXT:    [[TMP5:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds (%struct.single_cap, %struct.single_cap* @single_cap, i32 0, i32 0), align 16
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 1, i8 addrspace(200)* [[TMP5]])
// RV64IXCHERI-NEXT:    [[TMP6:%.*]] = bitcast %struct.double_cap* [[BYVAL_TEMP]] to i8*
// RV64IXCHERI-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 [[TMP6]], i8* align 16 bitcast (%struct.double_cap* @double_cap to i8*), i64 32, i1 false)
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 2, %struct.double_cap* [[BYVAL_TEMP]])
// RV64IXCHERI-NEXT:    [[TMP7:%.*]] = load [1 x i8 addrspace(200)*], [1 x i8 addrspace(200)*]* getelementptr inbounds (%struct.single_cap_array, %struct.single_cap_array* @single_cap_array, i32 0, i32 0), align 16
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 3, [1 x i8 addrspace(200)*] [[TMP7]])
// RV64IXCHERI-NEXT:    [[TMP8:%.*]] = bitcast %struct.double_cap_array* [[BYVAL_TEMP1]] to i8*
// RV64IXCHERI-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 [[TMP8]], i8* align 16 bitcast (%struct.double_cap_array* @double_cap_array to i8*), i64 32, i1 false)
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 4, %struct.double_cap_array* [[BYVAL_TEMP1]])
// RV64IXCHERI-NEXT:    [[TMP9:%.*]] = bitcast %struct.mixed* [[BYVAL_TEMP2]] to i8*
// RV64IXCHERI-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 [[TMP9]], i8* align 16 bitcast (%struct.mixed* @mixed to i8*), i64 32, i1 false)
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 5, %struct.mixed* [[BYVAL_TEMP2]])
// RV64IXCHERI-NEXT:    [[TMP10:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)** getelementptr inbounds (%union.int_or_cap, %union.int_or_cap* @int_or_cap, i32 0, i32 0), align 16
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 6, i8 addrspace(200)* [[TMP10]])
