...
// CHECK: [[GR_OFFS:%[a-z_0-9]+]] = load i32, i32 addrspace(200)* getelementptr inbounds (%"struct.std::__va_list", %"struct.std::__va_list" addrspace(200)* @the_list, i32 0, i32 3)
...
// CHECK: store i32 [[NEW_REG_OFFS]], i32 addrspace(200)* getelementptr inbounds (%"struct.std::__va_list", %"struct.std::__va_list" addrspace(200)* @the_list, i32 0, i32 3)
// CHECK: [[INREG:%[a-z_0-9]+]] = icmp sle i32 [[NEW_REG_OFFS]], 0
// CHECK: br i1 [[INREG]], label %[[VAARG_IN_REG:[a-z_.0-9]+]], label %[[VAARG_ON_STACK]]

// CHECK: [[VAARG_IN_REG]]
// CHECK:[[REG_TOP:%[a-z_0-9]+]] = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* getelementptr inbounds (%"struct.std::__va_list", %"struct.std::__va_list" addrspace(200)* @the_list, i32 0, i32 1)
...
// CHECK: [[STACK:%[a-z_0-9]+]] = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* getelementptr inbounds (%"struct.std::__va_list", %"struct.std::__va_list" addrspace(200)* @the_list, i32 0, i32 0)
// CHECK: [[NEW_STACK:%[a-z_0-9]+]] =  getelementptr inbounds i8, i8 addrspace(200)* [[STACK]], i64 8
// CHECK: i8 addrspace(200)* [[NEW_STACK]], i8 addrspace(200)* addrspace(200)* getelementptr inbounds (%"struct.std::__va_list", %"struct.std::__va_list" addrspace(200)* @the_list, i32 0, i32 0)
