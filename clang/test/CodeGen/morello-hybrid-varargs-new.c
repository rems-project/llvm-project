...
// RUN:    -morello-vararg=new -emit-llvm -o - %s -disable-O0-optnone | \
// RUN:  opt -S -mem2reg | \
// RUN:  FileCheck  %s
...
// CHECK-NEXT:    [[TMP0:%.*]] = call i8 addrspace(200)* @llvm.cheri.cap.address.set.i64(i8 addrspace(200)* null, i64 0)
// CHECK-NEXT:    store i8 addrspace(200)* [[TMP0]], i8 addrspace(200)** [[INDIRECT_ARG_TEMP]], align 16
