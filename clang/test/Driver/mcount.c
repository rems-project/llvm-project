...
// RUN: %clang -target aarch64-linux-gnueabi -c -### %s -mnop-mcount -mrecord-mcount 2>&1 | FileCheck --check-prefix=ERR2 %s
...
// ERR2: error: unsupported option '-mnop-mcount' for target 'aarch64-unknown-linux-gnueabi'
// ERR2: error: unsupported option '-mrecord-mcount' for target 'aarch64-unknown-linux-gnueabi'
