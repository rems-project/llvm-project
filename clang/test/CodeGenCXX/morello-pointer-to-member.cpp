...
// CHECK-NEXT:    call void @_ZN1AC2Ev([[CLASS_A]] addrspace(200)* nonnull dereferenceable(24) [[A]]) #[[ATTR8:[0-9]+]]
...
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i8, i8 addrspace(200)* [[VTABLE]], i64 [[MEMPTR_VTABLE_OFFSET]], !nosanitize !7
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast i8 addrspace(200)* [[TMP6]] to i32 ([[CLASS_A]] addrspace(200)*) addrspace(200)* addrspace(200)*, !nosanitize !7
// CHECK-NEXT:    [[MEMPTR_VIRTUALFN:%.*]] = load i32 ([[CLASS_A]] addrspace(200)*) addrspace(200)*, i32 ([[CLASS_A]] addrspace(200)*) addrspace(200)* addrspace(200)* [[TMP7]], align 16, !nosanitize !7
...
// CHECK-NEXT:    [[CALL:%.*]] = call i32 [[TMP8]]([[CLASS_A]] addrspace(200)* nonnull dereferenceable(24) [[THIS_ADJUSTED]])
...
// CHECK-NEXT:    call void @_ZN6PR75561AD1Ev(%"struct.PR7556::A" addrspace(200)* nonnull dereferenceable(1) [[AGG_TMP_ENSURED]]) #[[ATTR8]]
...
// CHECK-NEXT:    call void @_ZN6PR75561BD1Ev(%"struct.PR7556::B" addrspace(200)* nonnull dereferenceable(4) [[AGG_TMP_ENSURED1]]) #[[ATTR8]]
...
// CHECK-NEXT:    call void @_ZN6PR75561CD1Ev(%"struct.PR7556::C" addrspace(200)* nonnull dereferenceable(8) [[AGG_TMP_ENSURED2]]) #[[ATTR8]]
// CHECK-NEXT:    ret void
//
  void foo() {
    A();
