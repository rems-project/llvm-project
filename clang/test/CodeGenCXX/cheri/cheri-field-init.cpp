...
// PURECAP-NEXT:    call void @_ZN3foo3barC1ERKS0_(%"struct.foo::bar" addrspace(200)* [[A1]], %"struct.foo::bar" addrspace(200)* nonnull align 4 dereferenceable(8) [[A12]])
...
// PURECAP-NEXT:  entry:
// PURECAP-NEXT:    call void @_ZN3fooC2ERKS_([[STRUCT_FOO:%.*]] addrspace(200)* [[THIS:%.*]], [[STRUCT_FOO]] addrspace(200)* nonnull align 16 dereferenceable(48) [[TMP0:%.*]])
// PURECAP-NEXT:    ret void
//
//
...
// PURECAP-NEXT:    call void @_ZN3baz3bizC1ERKS0_(%"struct.baz::biz" addrspace(200)* [[A1]], %"struct.baz::biz" addrspace(200)* nonnull align 4 dereferenceable(8) [[A12]])
...
// PURECAP-NEXT:  entry:
// PURECAP-NEXT:    call void @_ZN3bazC2ERKS_([[STRUCT_BAZ:%.*]] addrspace(200)* [[THIS:%.*]], [[STRUCT_BAZ]] addrspace(200)* nonnull align 16 dereferenceable(48) [[TMP0:%.*]])
// PURECAP-NEXT:    ret void
//
//
...
// HYBRID-NEXT:    call void @_ZN3foo3barC1ERKS0_(%"struct.foo::bar"* [[A1]], %"struct.foo::bar"* nonnull align 4 dereferenceable(8) [[A12]])
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    call void @_ZN3fooC2ERKS_(%struct.foo* [[THIS:%.*]], %struct.foo* nonnull align 16 dereferenceable(48) [[TMP0:%.*]])
// HYBRID-NEXT:    ret void
//
//
...
// HYBRID-NEXT:    call void @_ZN3baz3bizC1ERKS0_(%"struct.baz::biz"* [[A1]], %"struct.baz::biz"* nonnull align 4 dereferenceable(8) [[A12]])
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    call void @_ZN3bazC2ERKS_(%struct.baz* [[THIS:%.*]], %struct.baz* nonnull align 16 dereferenceable(48) [[TMP0:%.*]])
// HYBRID-NEXT:    ret void
//
