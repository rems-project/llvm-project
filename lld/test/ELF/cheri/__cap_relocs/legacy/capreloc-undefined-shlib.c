...
// SHLIB-RELOCS-NEXT:     0x204D0 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE - 0x0 (real addend unknown)
//                           ^--- Location for foo_ptr
// SHLIB-RELOCS-NEXT:     0x204F8 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE - 0x0 (real addend unknown)
//                           ^--- Location for bar_ptr
// SHLIB-RELOCS-NEXT:     0x20500 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE - 0x0 (real addend unknown)
//                           ^--- Target for bar_ptr (since it is not preemptible this is resolved against the load address)
// SHLIB-RELOCS-NEXT:     0x204D8 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE foo 0x0 (real addend unknown)
//                           ^--- Target for foo_ptr
// SHLIB-RELOCS-NEXT:     0x204E8 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE foo 0x0 (real addend unknown)
//                           ^--- Size for foo_ptr
// SHLIB-RELOCS-NEXT:  }
// SHLIB-RELOCS-NEXT:]
