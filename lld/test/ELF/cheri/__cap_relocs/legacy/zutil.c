...
// CHECK-NEXT:  0x00000000000204c0	      Base: <Unnamed symbol> (0x0000000000000499)	Offset: 0x0000000000000000	Length: 0x000000000000001b	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x00000000000204{{d|e}}0	Base: <Unnamed symbol> (0x00000000000004a9)	Offset: 0x0000000000000000	Length: 0x000000000000000b	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x0000000000020{{4e|50}}0	Base: <Unnamed symbol> (0x0000000000000498)	Offset: 0x0000000000000000	Length: 0x000000000000001c	Permissions: 0x4000000000000000 (Constant)
