...
// SHLIB-RELOCS-UNSORTED1-NEXT:      0x0 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
// SHLIB-RELOCS-UNSORTED1-NEXT:      0x28 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
// SHLIB-RELOCS-UNSORTED1-NEXT:      0x8 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE foo{{$}}
// SHLIB-RELOCS-UNSORTED1-NEXT:      0x18 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE foo{{$}}
// SHLIB-RELOCS-UNSORTED1-NEXT:      0x30 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE bar{{$}}
// SHLIB-RELOCS-UNSORTED1-NEXT:      0x40 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE bar{{$}}
...
// SHLIB-RELOCS-UNSORTED2-NEXT:      0x0 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
// SHLIB-RELOCS-UNSORTED2-NEXT:      0x28 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
// SHLIB-RELOCS-UNSORTED2-NEXT:      0x8 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE bar{{$}}
// SHLIB-RELOCS-UNSORTED2-NEXT:      0x18 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE bar{{$}}
// SHLIB-RELOCS-UNSORTED2-NEXT:      0x30 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE foo{{$}}
// SHLIB-RELOCS-UNSORTED2-NEXT:      0x40 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE foo{{$}}
