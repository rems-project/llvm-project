...
// PER-FILE-NEXT:     0x20A10 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int 0x0
// PER-FILE-NEXT:     0x20A40 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int 0x0
// PER-FILE-NEXT:     0x20A60 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int 0x0
// PER-FILE-NEXT:   }
// PER-FILE-NEXT:   Section ({{.+}}) .rel.plt {
// PER-FILE-NEXT:     0x209E0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_void_ptr 0x0
// PER-FILE-NEXT:     0x209F0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr 0x0
// PER-FILE-NEXT:     0x20A00 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_int 0x0
// PER-FILE-NEXT:     0x20A30 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr 0x0
// PER-FILE-NEXT:     0x20A50 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr 0x0
// PER-FILE-NEXT:   }
// PER-FILE-NEXT: ]
...
// GLOBAL-NEXT:     0x208C0 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int 0x0
// GLOBAL-NEXT:   }
// GLOBAL-NEXT:   Section (8) .rel.plt {
// GLOBAL-NEXT:     0x20890 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_void_ptr 0x0
// GLOBAL-NEXT:     0x208A0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr 0x0
// GLOBAL-NEXT:     0x208B0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_int 0x0
// GLOBAL-NEXT:   }
// GLOBAL-NEXT: ]
