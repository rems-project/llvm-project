// RUN: llvm-mc --triple=aarch64-none-elf -target-abi purecap -mattr=+c64,+morello -filetype=obj %S/Inputs/shared-datalib.s -o %t.o
...
// RELS-NEXT:     0x220370 R_MORELLO_RELATIVE from_app 0x0
/// .capinit data
...
/// .capinit from_app (strictly speaking don't need symbol here)
// RELS-PIE-NEXT:     0x20370 R_MORELLO_RELATIVE from_app 0x0
/// .capinit data
