...
// RELS: Relocations
// RELS-NEXT: .rela.dyn
// RELS-NEXT: 0x202E0 R_MORELLO_RELATIVE - 0x3

/// Check the fragment at location pointed by the Relocation (0x20300)
// CHECK: Contents of section .data.rel.ro:
// CHECK: 202e0 a0030300 00000000 20000000 00000002

/// Check that data (DEADBEEF) starts at the location pointed by the fragment
/// 0x30320
// CHECK: Contents of section .data:
// CHECK: 303a0 0d000000 00000000 0e000000 00000000
// CHECK: 303b0 0a000000 00000000 0d000000 00000000
// CHECK: 303c0 0b000000 00000000 0e000000 00000000
// CHECK: 303d0 0e000000 00000000 0f000000 00000000
