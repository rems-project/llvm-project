...
// CHECK-NEXT:  208a0 00000000 00000000 00000000 00000002
...
// CHECK-NEXT:  208e0 40020000 00000000 40070300 00000004
...
// CHECK-LABEL: <caller>:
// CHECK-NEXT:    10600:        bl      0x10670 <importfunc+0x10670>
// CHECK-NEXT:                  bl      0x105e0 <hiddenfunc>
// CHECK-NEXT:                  bl      0x105f0 <localfunc>
// CHECK-NEXT:                  bl      0x10680 <importfunc+0x10680>
// CHECK-NEXT:                  ret     c30
// CHECK-NEXT:                  adrp    c0, 0x20000 <importfunc+0x10654>
// CHECK-NEXT:                  ldr     c0, [c0, #0x880]
// CHECK-NEXT:                  adrp    c1, 0x20000 <importfunc+0x1065c>
// CHECK-NEXT:                  ldr     c1, [c1, #0x890]
// CHECK-NEXT:                  adrp    c2, 0x20000 <importfunc+0x10664>
// CHECK-NEXT:                  ldr     c2, [c2, #0x8e0]
// CHECK-NEXT:                  adrp    c3, 0x20000 <importfunc+0x1066c>
// CHECK-NEXT:                  ldr     c3, [c3, #0x8a0]
// CHECK-NEXT:                  adrp    c4, 0x20000 <importfunc+0x10674>
// CHECK-NEXT:                  ldr     c4, [c4, #0x8c0]
// CHECK-NEXT:                  adrp    c5, 0x20000 <importfunc+0x1067c>
// CHECK-NEXT:                  ldr     c5, [c5, #0x8d0]
// CHECK-NEXT:                  adrp    c17, 0x20000 <importfunc+0x10684>
// CHECK-NEXT:                  ldr     c17, [c17, #0x8b0]
