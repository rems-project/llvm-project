...
/// Check that we error somewhat gracefully when using the wrong ABI..

// CHECK: error: Morello PLT/GOT generating relocation R_MORELLO_CALL26 requires the purecap ABI
...
// CHECK-EMPTY:
// CHECK: error: Morello PLT/GOT generating relocation R_MORELLO_JUMP26 requires the purecap ABI
// CHECK-NEXT: >>> defined in {{.+}}aarch64-missing-morello-c64-plt-err.s.tmp.o
